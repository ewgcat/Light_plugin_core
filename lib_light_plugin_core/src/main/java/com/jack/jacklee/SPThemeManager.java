...
//                LayoutInflaterCompat.setFactory2(LayoutInflater.from(delegate), new MyFactory());
    ...
    public SPThemeManager updateThemeConfig(Context context, String name){
        JackUtils.getSharedPreferences(context).edit().putString(THEME_KEY_NAME, name).apply();
        return this;
    }

    public SPThemeManager init(Context context) {
        this.context=context;
        String tname = JackUtils.getSharedPreferences(context).getString(THEME_KEY_NAME, DEFAULT_THEMES);
    ...
    public SPThemeManager changeTheme(String tname){
        if (tname.equals(DEFAULT_THEMES)){
            ...
            if (file==null) {
                ...
                JackUtils.getSharedPreferences(context).edit().putString(THEME_KEY_NAME, tname).apply();
    ...
    private void defaultTheme(Context context) {
        ...
        JackUtils.getSharedPreferences(context).edit().putString(THEME_KEY_NAME, DEFAULT_THEMES).apply();
    ...
    public int rid(int rid, String type){
        return rid(JackUtils.getNameByRid(context, rid), type);
    }
    ...
    public int color(int rid){
        return color(JackUtils.getNameByRid(context, rid));
    }
    ...
    public Drawable drawable(int rid){
        return drawable(JackUtils.getNameByRid(context, rid));
    }
