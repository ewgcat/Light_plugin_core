...
public class JackUtils {
    ...
    public static final String tag="JackUtils";
    ...
    public static void goActivity(Activity activity, String apkName, String className){
        Intent intent=new Intent(Intent.ACTION_VIEW, Uri.parse(JackConfig.ACTIVITY_URL));
        intent.setPackage(activity.getPackageName());
        intent.putExtra(JackConfig.APK_NAME, apkName);
        intent.putExtra(JackConfig.CLASS_TAG, className);
